...
//!
//! 진입 직후:
//!   1. `sys_write(2, msg, msg_len)` 로 커널이 VGA 에 메시지 출력
//!   2. `sys_getrandom(buf, 16)` 로 커널 DRBG 에서 16 바이트 수신
//!   3. `sys_write(2, hex_buf, 32)` 로 16-byte 엔트로피를 hex 16진수로 출력
//!   4. `sys_exit(0)` 로 정상 종료
//!
